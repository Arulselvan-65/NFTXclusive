...
import { Clock, Shield, Tag, Wallet } from 'lucide-react';
...
const NFTDetailsPage = ({ nft }: { nft?: NFTDetails }) => {
  const defaultNFT: NFTDetails = {
    id: 1,
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 mt-8">
        ...
        <div className="w-full lg:w-2/5 lg:sticky lg:top-8 lg:self-start">
          <div className="group bg-[#2a2a2a]/50 rounded-2xl overflow-hidden border border-gray-800/50 backdrop-blur-sm">
            ...
            <div className="p-3">
              <h1 className="text-2xl font-bold mb-4">{displayNFT.name}</h1>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                      {displayNFT.price} {displayNFT.currency}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full lg:w-3/5 space-y-6">
          ...
          <div className="bg-[#2a2a2a]/30 rounded-xl p-6 border border-gray-800/50 backdrop-blur-sm">
            ...
            <p className="text-gray-300 leading-relaxed">{displayNFT.description}</p>
          </div>

          <div className="bg-[#2a2a2a]/30 rounded-xl p-6 border border-gray-800/50 backdrop-blur-sm">
            <h2 className="text-xl font-bold mb-4">Details</h2>
            <div className="space-y-3">
              {displayNFT.details.map((detail, index) => (
          ...
          <div className="bg-[#2a2a2a]/30 rounded-xl p-6 border border-gray-800/50 backdrop-blur-sm">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
              <div>
                ...
                <p className="text-2xl font-bold">{displayNFT.price} {displayNFT.currency}</p>
              </div>
